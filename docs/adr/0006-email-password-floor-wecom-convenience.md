...
>
> **Qualified again by [ADR-0039](0039-signing-up-creates-a-new-empty-organisation-behind-a-beta-code.md) (#178).** "Created by invitation, never otherwise" gains one more door: signing up in the app, which creates a new organisation and its first Membership through the service role. Nothing arrives by scanning, and the platform's own signup endpoint stays shut.
