    ...
    <li className="flex flex-col">
      ...
      >
        <button
          ...
          className="hover:bg-muted focus-visible:ring-ring inline-flex size-11 shrink-0 items-center justify-center rounded-control focus-visible:ring-3 focus-visible:outline-none"
