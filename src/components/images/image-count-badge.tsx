  ...
  return (
    <>
      <button
        ...
        className="text-muted-foreground hover:text-foreground focus-visible:ring-ring border-border inline-flex h-11 w-fit items-center gap-1.5 rounded-control border px-2.5 text-sm focus-visible:ring-3 focus-visible:outline-none"
        onClick={() => setOpenAt(0)}
      >
