      ...
      <fieldset className="flex flex-col gap-2">
        ...
        <div className="flex flex-wrap gap-2">
          {matchTypes.map((option) => (
            <label
              key={option}
              className="border-input has-checked:border-ring has-checked:bg-muted focus-within:ring-ring flex h-11 cursor-pointer items-center gap-2 rounded-control border px-3 text-sm focus-within:ring-3"
            >
              <input
                type="radio"
                name="matchType"
