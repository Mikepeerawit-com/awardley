...
describe("what the session gate lets through", () => {
   ...
   * caller: a signed-out human, a link in an email, a person creating an organisation,
   * an uptime probe, and Vercel Cron.
   */
  it.each([
    ...
    [
      "/signup",
      "somebody creating an organisation, who by definition cannot be signed in yet",
    ],
